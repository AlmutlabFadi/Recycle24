const DEMO_USERS: Record<string, { id: string; phone: string | null; email: string | null; password: string; name: string; firstName: string; lastName: string; titleId: string; gender: string; userType: string; status: string; role: string }> = {
    "test@test.com": {
        id: "demo_trader_1",
        phone: null,
        email: "test@test.com",
